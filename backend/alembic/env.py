...
Uses asyncio run mode with asyncpg driver.
...
# Convert asyncpg URL to sync for Alembic's internal use if needed;
# async_engine_from_config handles asyncpg directly.
